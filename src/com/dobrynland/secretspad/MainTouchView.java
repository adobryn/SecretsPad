...
public class MainTouchView extends View implements View.OnLongClickListener, View.OnClickListener
{
    ...
    public void onClick(View v) {
        Toast msg = Toast.makeText(MainTouchView.this.getContext(), "onClick", Toast.LENGTH_SHORT);
    ...
    public boolean onLongClick(View v) {
        Toast msg = Toast.makeText(MainTouchView.this.getContext(), "onLongClick", Toast.LENGTH_SHORT);
        msg.setGravity(Gravity.CENTER, msg.getXOffset() / 2, msg.getYOffset() / 2);
        msg.show();
